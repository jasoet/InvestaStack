...
public class CaptchaVerifierFilter extends OncePerRequestFilter {
    ...
    public void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
        ...
        logger.debug("challenge: " + captchaCaptureFilter.getReCaptchaChallenge());
        logger.debug("response: " + captchaCaptureFilter.getReCaptchaResponse());
        logger.debug("remoteAddr: " + captchaCaptureFilter.getRemoteAddr());

        // Assign values only when user has submitted a Captcha value
        if (captchaCaptureFilter.getReCaptchaResponse() != null) {
            ...
            try {
                ...
                ReCaptchaResponse reCaptchaResponse = reCaptcha.checkAnswer(captchaCaptureFilter.getRemoteAddr(), captchaCaptureFilter.getReCaptchaChallenge(), captchaCaptureFilter.getReCaptchaResponse());
                ...
                // Redirect user to login page
                failureHandler.setDefaultFailureUrl(failureUrl);
                failureHandler.onAuthenticationFailure(req, res, new BadCredentialsException("Connection Lost!"));
            }
    ...
    public void resetCaptchaFields() {
        ...
        captchaCaptureFilter.setReCaptchaChallenge(null);
        captchaCaptureFilter.setReCaptchaResponse(null);
    }
